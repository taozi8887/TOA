...
class AutoUpdater:
    ...
    def check_for_updates(self, directories: List[str] = None) -> Tuple[bool, List[str]]:
        """
...
def create_version_file(directories: List[str] = None, output_file: str = "version.json"):
    """
